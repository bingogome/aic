...
def create_training_config(
    ...
    # No HuggingFace Hub pushing - train locally only
...
def main():
    parser = argparse.ArgumentParser(description="Train ACT policy on AIC synthetic data")
    ...
    parser.add_argument("--use_vae", action="store_true", default=True, help="Enable VAE")
    parser.add_argument("--no_vae", action="store_false", dest="use_vae", help="Disable VAE")
    ...
    parser.add_argument("--wandb_project", type=str, default="aic-act", help="Wandb project name")
    ...
    for subdir in required_subdirs:
        ...
        if not subdir_path.exists():
            raise FileNotFoundError(f"Required subdirectory {subdir_path} does not exist")
